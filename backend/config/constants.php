...
define('DB_USER', 'if0_40308362');
define('DB_PASS', 'esTLOj3jMoR');
define('DB_NAME', 'if0_40308362_dbbank'); // Database já existe no InfinityFree

// JWT Secret Key - Chave aleatória segura
